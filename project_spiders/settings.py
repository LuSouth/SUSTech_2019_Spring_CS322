...
SPIDER_MODULES = ['project_spiders.spiders']
NEWSPIDER_MODULE = 'project_spiders.spiders'
...
ITEM_PIPELINES = {
   'project_spiders.pipelines.ProjectSpidersPipeline': 300,
}
...
#    'project_spiders.middlewares.ProjectSpidersDownloaderMiddleware': 543,
# }
